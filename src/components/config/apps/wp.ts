...
const wpConfig: CommonAppMapping = {
  ...
  driveLinks: [
    {
      drive: 'https://drive.google.com/drive/folders/1EfT75V7exDhoOh_LtuKhS9kKX2uG4hSu?usp=drive_link',
      journal: 'https://docs.google.com/spreadsheets/d/1bv0Jc4-dJe8neKpxVp2PFCFvXNOnCcuj/edit?usp=drive_link&ouid=112734872675001245593&rtpof=true&sd=true',
      name: 'KI-401',
    },
    {
      drive: 'https://drive.google.com/drive/folders/1gap9EXqO8f4QuX2nj4LuAoDu5Cw9SGYM?usp=drive_link',
      journal: 'https://docs.google.com/spreadsheets/d/1rGd-FZE34O_3BvnYhOOABsKrlDTXMXFt/edit?usp=drive_link&ouid=112734872675001245593&rtpof=true&sd=true',
      name: 'KI-402',
    },
    {
      drive: 'https://drive.google.com/drive/folders/1YrC5QcJaSZNbZ5YFaSbA33yd8SpSG_s4?usp=drive_link',
      journal: 'https://docs.google.com/spreadsheets/d/1Z2yizCxPc0fMO-xKA9tedl6rwj56xa5k/edit?usp=drive_link&ouid=112734872675001245593&rtpof=true&sd=true',
      name: 'KI-403',
    },
    {
      drive: 'https://drive.google.com/drive/folders/1nzimiXxxsYztOc0R0vcVkNE8sP-BDJbq?usp=drive_link',
      journal: 'https://docs.google.com/spreadsheets/d/18IjYQCmB2yhzLi5PIOh7bCjUKnvkYkds/edit?usp=drive_link&ouid=112734872675001245593&rtpof=true&sd=true',
      name: 'KI-404',
    },
    {
      drive: 'https://drive.google.com/drive/folders/1AtbYg-bsc7EzLJPKB6iN6LeBS3-Ek-KN?usp=drive_link',
      journal: 'https://docs.google.com/spreadsheets/d/1S-N7scOX5X5pbMIMmASr15vqmdq1Nlxb/edit?usp=drive_link&ouid=112734872675001245593&rtpof=true&sd=true',
      name: 'KI-405',
    },
    {
      drive: 'https://drive.google.com/drive/folders/1D1uih0L2kKqV3YMMQXhoOePj5lYVE6o4?usp=drive_link',
      journal: 'https://docs.google.com/spreadsheets/d/16BqY9d-vgDM-O_79_rHhIzDlLY0q4KiK/edit?usp=drive_link&ouid=112734872675001245593&rtpof=true&sd=true',
      name: 'KI-406',
    },
  ],
  ...
  homePage: {
    ...
    fullInfoSection: {
      roadmap: [
        ...
        {
          description: 'Оцінювання знань студента у вигляді технічної співбесіди на обрану тему.',
          title: 'Усна компонента (опціонально)',
          type: 'interview',
        },
        {
          description: 'LeetCode задачі - це завдання на онлайн ресурсі LeetCode, яке практично демонструє вимоги до технічого кандидата під час співбесіди в IT. Бали за задачі будуть враховані під час заліку',
          title: 'LeetCode задачі (опціонально, входять у бали до заліку)',
          type: 'interview',
        },
        {
