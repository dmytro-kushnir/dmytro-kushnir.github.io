      ...
      labList: [
        {
          ...
          id: 'lab1',
          imgSrc: '/images/apps/comp-arch/labs/lab1.jpg',
          link: '/labs/lab1',
          name: 'Лабараторна №1',
        ...
        },
        {
          ...
          id: 'lab2',
          imgSrc: '/images/apps/comp-arch/labs/lab2.jpg',
          link: '/labs/lab2',
          name: 'Лабараторна №2',
          objective: 'Вивчити основні типи даних та оператори мови JavaScript.',
        },
        {
          ...
          id: 'lab3',
          imgSrc: '/images/apps/comp-arch/labs/lab3.jpg',
          link: '/labs/lab3',
          name: 'Лабараторна №3',
        ...
        },
        {
          ...
          id: 'lab4',
          imgSrc: '/images/apps/comp-arch/labs/lab4.jpg',
          link: '/labs/lab4',
          name: 'Лабараторна №4',
        ...
        },
        {
          ...
          id: 'lab5',
          imgSrc: '/images/apps/comp-arch/labs/lab5.jpg',
          link: '/labs/lab5',
          name: 'Лабараторна №5',
        ...
        },
        {
          ...
          id: 'lab6',
          imgSrc: '/images/apps/comp-arch/labs/lab6.jpg',
          link: '/labs/lab6',
          name: 'Лабараторна №6',
      ...
      lecturesList: [
        {
          ...
          filePath: '/files/apps/comp-arch/lectures/1.pdf',
          id: 'lecture1',
          imageUrl: '/images/apps/comp-arch/lectures/lecture1.webp',
        ...
        },
        {
          ...
          filePath: '/files/apps/comp-arch/lectures/2.pdf',
          id: 'lecture2',
          imageUrl: '/images/apps/comp-arch/lectures/lecture2.jpg',
          name: 'Протокол HTTP. Принципи функціонування.',
        },
        {
          description: 'Браузер. Склад і загальні принципи роботи.',
          filePath: '/files/apps/comp-arch/lectures/3.pdf',
          id: 'lecture3',
          imageUrl: '/images/apps/comp-arch/lectures/lecture3.webp',
        ...
        },
        {
          ...
          filePath: '/files/apps/comp-arch/lectures/4.pdf',
          id: 'lecture4',
          imageUrl: '/images/apps/comp-arch/lectures/lecture4.jpg',
          name: 'Веб сервер. Апаратне і програмне забезпечення.',
        },
        {
          description: 'Веб-додатки. Поняття, компоненти та принципи роботи.',
          filePath: '/files/apps/comp-arch/lectures/5.pdf',
          id: 'lecture5',
          imageUrl: '/images/apps/comp-arch/lectures/lecture5.webp',
          name: 'Веб-додатки. Поняття, компоненти та принципи роботи.',
          subLectures: [
            { filePath: '/files/apps/comp-arch/lectures/5.1.pdf', id: 'lecture5.1', name: 'Веб-додатки для колективної роботи.' },
          ],
        },
        {
          description: 'Архітектура веб-додатків.',
          filePath: '/files/apps/comp-arch/lectures/6.pdf',
          id: 'lecture6',
          imageUrl: '/images/apps/comp-arch/lectures/lecture6.webp',
          name: 'Архітектура веб-додатків.',
        },
        {
          description: 'Етапи реалізації веб-проєкту.',
          filePath: '/files/apps/comp-arch/lectures/7.pdf',
          id: 'lecture7',
          imageUrl: '/images/apps/comp-arch/lectures/lecture7.webp',
          name: 'Етапи реалізації веб-проєкту.',
        },
        {
          description: 'Етап аналітики в проєктуванні веб додатку.',
          filePath: '/files/apps/comp-arch/lectures/8.pdf',
          id: 'lecture8',
          imageUrl: '/images/apps/comp-arch/lectures/lecture8.jpg',
          name: 'Етап аналітики в проєктуванні веб додатку.',
        },
        {
          description: 'Дизайн-макети, frontend, backend, тестування веб додатку.',
          filePath: '/files/apps/comp-arch/lectures/9.pdf',
          id: 'lecture9',
          imageUrl: '/images/apps/comp-arch/lectures/lecture9.webp',
        ...
        },
        {
          ...
          filePath: '/files/apps/comp-arch/lectures/10.pdf',
          id: 'lecture10',
          imageUrl: '/images/apps/comp-arch/lectures/lecture10.jpg',
          name: 'Фронтенд-розробка. Ключові технології та поняття.',
          subLectures: [
            { filePath: '/files/apps/comp-arch/lectures/10.1.pdf', id: 'lecture10.1', name: 'Мова HTML. Поняття, стандарти, теги та атрибути.' },
            { filePath: '/files/apps/comp-arch/lectures/10.2.pdf', id: 'lecture10.2', name: 'Структура сторінки, DOM-дерево, застосування тегів.' },
            { filePath: '/files/apps/comp-arch/lectures/10.3.pdf', id: 'lecture10.3', name: 'Сучасний CSS. Основні поняття, селектори, блокова модель.' },
            { filePath: '/files/apps/comp-arch/lectures/10.4.pdf', id: 'lecture10.4', name: 'CSS. Типи даних та робота з HTML-елементами.' },
            { filePath: '/files/apps/comp-arch/lectures/10.5.pdf', id: 'lecture10.5', name: 'CSS. Стилі коду та побудова макетів.' },
            { filePath: '/files/apps/comp-arch/lectures/10.6.pdf', id: 'lecture10.6', name: 'JavaScript у веб-розробці.' },
            { filePath: '/files/apps/comp-arch/lectures/10.7.pdf', id: 'lecture10.7', name: 'JavaScript фреймворки.' },
          ],
        },
        {
          ...
          filePath: '/files/apps/comp-arch/lectures/11.pdf',
          id: 'lecture11',
          imageUrl: '/images/apps/comp-arch/lectures/lecture11.jpg',
          name: 'Бекенд. Програмування серверної частини.',
          subLectures: [
            { filePath: '/files/apps/comp-arch/lectures/11.1.pdf', id: 'lecture11.1', name: 'Мови серверного програмування.' },
            { filePath: '/files/apps/comp-arch/lectures/11.2.pdf', id: 'lecture11.2', name: 'Бекенд фреймворки.' },
          ],
        },
        {
          description: 'Інструменти веб-розробника.',
          filePath: '/files/apps/comp-arch/lectures/12.pdf',
          id: 'lecture12',
          imageUrl: '/images/apps/comp-arch/lectures/lecture12.webp',
          name: 'Інструменти веб-розробника.',
          subLectures: [
            { filePath: '/files/apps/comp-arch/lectures/12.1.pdf', id: 'lecture12.1', name: 'Консоль розробника в браузері.' },
            { filePath: '/files/apps/comp-arch/lectures/12.2.pdf', id: 'lecture12.2', name: 'Системи контролю версій.' },
            { filePath: '/files/apps/comp-arch/lectures/12.3.pdf', id: 'lecture12.3', name: 'Тестування веб-додатків.' },
          ],
        },
      ],
      links,
