...
import VariantsFromJson from '../../components/variants/variantsFromJson.tsx';
...
export default function PeripheralDevicesApp({ appName }: Props) {
  const {
      ...
      <AppNameProvider appName={appName}>
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="variants" element={<VariantsFromJson />} />
